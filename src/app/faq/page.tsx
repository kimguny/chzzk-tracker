...
const faqs = [
  ...
  {
    q: "맞팔 취소 감지는 어떻게 작동하나요?",
    a: "조회할 때마다 맞팔 목록을 브라우저 로컬 저장소에 저장합니다. 다음 조회 시 이전 맞팔 목록과 비교해서 사라진 사람을 맞팔 취소한 사람으로 표시합니다. 처음 조회할 때는 비교 대상이 없으므로 두 번째 조회부터 감지됩니다.",
  },
  {
    q: "이전 조회 기록은 어디 저장되나요?",
    a: "서버가 아닌 본인 브라우저의 로컬 저장소(localStorage)에 저장됩니다. 다른 기기나 다른 브라우저에서는 이전 기록이 없어서 맞팔 취소 감지가 되지 않습니다.",
  },
  {
